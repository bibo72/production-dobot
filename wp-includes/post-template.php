...
function post_class( $class = '', $post_id = null ) {
    ...
    if(
        ...
        || get_post_meta(get_the_ID(),'post_tutorial',true) ||
        substr_count($categories[0]->slug,'official-tutorial')
    ) {
        echo 'class="' . join(' ', get_post_class($class, $post_id)) . ' category-customer-video"';
    }else{

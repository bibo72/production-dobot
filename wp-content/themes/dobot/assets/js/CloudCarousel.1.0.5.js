...
{var img=item.image;w=img.width=item.orgWidth*scale;h=img.height=item.orgHeight*scale;img.style.left=x+px;img.style.top=y+px;img.style.zIndex=""+(scale*100)>>0;if((scale*100)>>0==100){$(img).addClass('current');}else{$(img).removeClass('current');}

...
add_action( 'storefront_header', 'language_switcher', 80 );
add_action( 'storefront_header', 'login_user_info', 72 );
...
add_action( 'storefront_loop_post',           'dobot_post_list',         30 );
...
add_action('dobot_slider_after','dobot_home_slider_after' ,10);

add_action('dobot_tutorial_before','dobot_tutorial_before',10);
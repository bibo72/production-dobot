...
function wc_customer_register_url() {
    $edit_account_url = wc_get_endpoint_url( 'customer-register', '', wc_get_page_permalink( 'myaccount' ) );

    return apply_filters( 'woocommerce_customer_register_url', $edit_account_url );
}

function wc_customer_login_url(){
    $edit_account_url = wc_get_endpoint_url( 'customer-login', '', wc_get_page_permalink( 'myaccount' ) );

    return apply_filters( 'woocommerce_customer_login_url', $edit_account_url );
}

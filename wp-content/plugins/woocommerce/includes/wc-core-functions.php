...
function wc_get_register_form() {
    $register_form = wc_get_template('myaccount/form-register.php',array());
    return $register_form;
}
add_shortcode( 'woocommerce_register_form', 'wc_get_register_form' );

function wc_get_login_form() {
    $login_form = wc_get_template('myaccount/form-login.php',array());
    return $login_form;
}
add_shortcode( 'woocommerce_login_form', 'wc_get_login_form' );

function wc_get_customer_head() {
    if(is_user_logged_in()) {
        $account_head_html = wc_get_template('myaccount/my-account-head.php', array());
        return $account_head_html;
    }
}
add_shortcode( 'my_account_head', 'wc_get_customer_head' );
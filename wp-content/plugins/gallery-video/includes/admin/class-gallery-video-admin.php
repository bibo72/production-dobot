					...
					if ( isset( $_POST["huge_it_add_video_input"] ) ) {
						if ( $_POST["huge_it_add_video_input"] != '' ) {
                            ...
                            $description = "<div class='video-player'>
                                <iframe src='".$video_url."' width='100%' height='100%' frameborder='0' allowfullscreen='allowfullscreen'></iframe>
                             </div>
                            ...
                            update_post_meta($post_id, 'post_video_cat', $id);
                            update_user_meta($user_id, 'user_video_'.$video_id, $video_id);
                            update_post_meta($post_id, 'video_secrecy', 'public');

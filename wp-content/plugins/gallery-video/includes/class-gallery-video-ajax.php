            ...
            if (!empty($_POST["page"]) && is_numeric($_POST['page']) && $_POST['page'] > 0) {
                ...
                foreach ($page_videos as $key => $row) {
                    ...
                    if ($videourl[1] == 'youtube') {
                        ...
                        $video_src = '//player.youku.com/embed/' . $videourl[0];
                        ...
                        $video = '<img src="' . $thumb_pic . '" alt="" />';
                        $video_src = '//www.youku.com/embed/' . $videourl[0];
                    } else {
            ...
            if (!empty($_POST["page"]) && is_numeric($_POST['page']) && $_POST['page'] > 0) {
                ...
                foreach ($page_videos as $key => $row) {
                    ...
                    if ($videourl[1] == 'youtube') {
                        ...
                        $video = '<a class="vyoutube huge_it_videogallery_item group1"  href="//www.youtube.com/embed/' . $videourl[0] . '" title="' . $video_name . '">
                                    <img src="' . $thumb_pic . '" alt="' . $video_name . '" />
                                    <div class="play-icon ' . $videourl[1] . ' youtube-icon"></div>
                                 </a>';
                    } else{
                        $hash = unserialize(wp_remote_fopen($protocol . "vimeo.com/api/v2/video/" . $videourl[0] . ".php"));
                        if (empty($row->thumb_url)) {
            ...
            if (!empty($_POST["page"]) && is_numeric($_POST['page']) && $_POST['page'] > 0) {
                ...
                foreach ($page_videos as $key => $row) {
                    ...
                    if ($videourl[1] == 'youtube') {
                        ...
                        $iframe = '<iframe class="video_view9_img" width="' . $gallery_video_get_option['gallery_video_video_ht_view9_video_width'] . '" height="' . $gallery_video_get_option['gallery_video_video_ht_view9_video_height'] . '" src="//player.youku.com/embed/' . $videourl[0] . '" style="border: 0;" allowfullscreen></iframe>';
                    }else {
